...
// access an item in a array using its index
...
if (5>20) {
    console.log('test returns fals, so we are pushed to the else ')
}else{
    console.log('we ended up in our else statement');
}

var num = 5;
//check to see if that  var is >10
//if it is, alert()
...
// create a funcation stored in a varible
